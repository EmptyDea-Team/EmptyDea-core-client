...
func (p *Players) GetOnline(ctx context.Context) (players []*Player, err error) {
...
func (p *Players) GetByUUIDString(ctx context.Context, id string) (player *Player, existed bool, err error) {
...
func (p *Players) GetByName(ctx context.Context, name string) (player *Player, existed bool, err error) {
...
func (p *Players) GetByUniqueID(ctx context.Context, id int64) (player *Player, existed bool, err error) {
...
func (p *Players) GetByRuntimeID(ctx context.Context, id uint64) (player *Player, existed bool, err error) {
	resp, err := p.client.GetPlayerByRuntimeID(ctx, &resources_control_pb.GetPlayerByRuntimeIDRequest{RuntimeID: id})
	return p.playerLookup(resp, err)
}

func (p *Players) playerLookup(resp *resources_control_pb.PlayerLookupResponse, err error) (player *Player, existed bool, retErr error) {
	if err != nil {
